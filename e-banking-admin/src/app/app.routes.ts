...
export const routes: Routes = [
  ...
  { path: 'referral', component: ReferralComponent,canActivate: [AuthGuard],data: { showNavbar: false }},
  { path: 'crypto', component: CryptoListComponent ,canActivate: [AuthGuard],data: { showNavbar: false }},
  { path: 'cryptotransactions', component: TransactionsComponent,canActivate: [AuthGuard],data: { showNavbar: false }},
